...
const presetWeights = [1, 1, 0, -3, -1, 2, 8, 40];  // 长片分数的影响力
const shortPresetWeights = [0, 0, 0, -5, -3, 1, 5, 25]; // 短片分数的影响力
...
const findRecommand = () => {
  const origin = openFilmOrigin(true).map(o => ({ ...o, userScore: o.userScore + 2 }));
